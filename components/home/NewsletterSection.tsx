    ...
    <section className="bg-canvas-paper py-24 px-4 sm:px-6 lg:px-8 border-b border-border">
      <div className="mx-auto max-w-archival">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm sm:text-base text-ink-muted leading-relaxed max-w-xl mx-auto font-sans">
            {language === 'ar'
          ...
          {isSubmitted ? (
            <div className="inline-flex items-center gap-2 p-4 bg-canvas-white border border-forest text-xs font-mono font-semibold text-forest rounded-2xl shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto pt-2">
              <input
                ...
                className="flex-1 bg-canvas-white border border-border px-5 py-3.5 text-xs text-ink placeholder-ink-muted/50 focus:outline-none focus:border-antiqueGold font-mono rounded-full shadow-sm"
              />
              <button
                type="submit"
                className="px-7 py-3.5 bg-forest text-canvas-white hover:bg-forest-light transition-all text-xs font-mono uppercase tracking-wider font-bold shrink-0 rounded-full shadow-md hover:shadow-lg"
              >
          ...
          <div className="flex items-center justify-center gap-4 text-[11px] font-mono text-ink-subtle pt-2">
